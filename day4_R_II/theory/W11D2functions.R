...
# tambien se puede utilizar dimnames, estas funciones son para poner nombre a las filas y columnas
...
#las funciones en R, el ultimo elemento por defecto es el que se retorna
#Se puede poner return pero se utiliza mas recursos
...
# funcion que elimina los nan para ejecutar la función 
sd(values, na.rm=TRUE)

#Generar un vector vacio, en este caso es numerico con una longitud de 8
vector("numeric", 8)
...
x= list(2,"a", "b")
x[[2]]
#los vectores solo pueden tener un tipo de objeto por lo que esa variable
#se guarda como numerica
vol = c(2, TRUE, 8)
#esta variable se guarda como caracter
vol2 = c("HOLA", TRUE, 8)